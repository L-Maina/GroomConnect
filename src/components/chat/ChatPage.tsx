  ...
  const [conversations, setConversations] = useState<Conversation[]>([
    {
      ...
      unreadCount: 2,
      messages: [
        { id: 'm1', senderId: 'user', content: 'Hi, I\'d like to book an appointment for a haircut.', timestamp: new Date(Date.now() - 1000 * 60 * 30), isRead: true, type: 'text' },
        { id: 'm2', senderId: 'b1', content: 'Hello! Sure, what time works for you?', timestamp: new Date(Date.now() - 1000 * 60 * 25), isRead: true, type: 'text' },
        { id: 'm3', senderId: 'user', content: 'Do you have anything available tomorrow afternoon?', timestamp: new Date(Date.now() - 1000 * 60 * 20), isRead: true, type: 'text' },
        { id: 'm4', senderId: 'b1', content: 'Sure, we have availability at 3 PM tomorrow.', timestamp: new Date(Date.now() - 1000 * 60 * 5), isRead: false, type: 'text' },
      ],
    },
    {
      id: '2',
      ...
      unreadCount: 0,
      messages: [
        { id: 'm5', senderId: 'b2', content: 'Your hair color appointment is confirmed!', timestamp: new Date(Date.now() - 1000 * 60 * 60 * 2), isRead: true, type: 'text' },
      ],
    },
    {
      id: '3',
      ...
      unreadCount: 0,
      messages: [
        { id: 'm6', senderId: 'user', content: 'Loved my nail art! Will definitely come back.', timestamp: new Date(Date.now() - 1000 * 60 * 60 * 25), isRead: true, type: 'text' },
        { id: 'm7', senderId: 'b3', content: 'Thank you for your review! 🙏', timestamp: new Date(Date.now() - 1000 * 60 * 60 * 24), isRead: true, type: 'text' },
      ],
    },
  ]);
                    ...
                    {showMoreMenu && (
                      <>
                        ...
                        <motion.div
                          ...
                          className="absolute right-0 top-full mt-1 w-48 glass-modal rounded-lg shadow-lg z-50 overflow-hidden"
                        >
                      ...
                      {showEmojiPicker && (
                        <>
                          ...
                          <motion.div
                            ...
                            animate={{ opacity: 1, y: 0, scale: 1 }}
                            exit={{ opacity: 0, y: 10, scale: 0.95 }}
                            className="absolute bottom-full mb-2 left-0 w-72 glass-modal rounded-xl shadow-lg z-50 overflow-hidden"
                          >
                            {/* Emoji Categories */}
