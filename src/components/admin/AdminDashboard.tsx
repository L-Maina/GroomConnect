...
import { useAdminStore, useAuthStore, useBusinessStore } from '@/store';
...
const sampleDisputes: Dispute[] = [
  {
    ...
    providerId: 'p1',
    providerName: 'Elite Cuts & Style',
    type: 'SERVICE_QUALITY',
    description: 'The haircut was not as requested. I asked for a fade but got a completely different style.',
    status: 'OPEN',
  ...
  },
  {
    ...
    type: 'REFUND_REQUEST',
    description: 'Service was cancelled by provider last minute. Requesting full refund.',
    status: 'IN_PROGRESS',
  ...
  },
  {
    ...
    providerId: 'p3',
    providerName: 'Nail Art Paradise',
    type: 'NO_SHOW',
    description: 'Provider did not show up for the appointment.',
    status: 'RESOLVED',
    resolution: { type: 'FULL_REFUND', amount: 60, notes: 'Full refund processed. Provider warned.' },
...
// Sample premium listings
const samplePremiumListings = [
  {
    id: 'pl1',
    businessId: 'b1',
  ...
  },
  {
    id: 'pl3',
    businessId: 'b5',
    businessName: 'Bold & Beautiful Makeup',
    plan: 'FEATURED',
    price: 99,
...
const sampleArticles: Article[] = [
  {
    id: 'a1',
    title: 'Top 10 Hair Trends for 2024',
    slug: 'top-10-hair-trends-2024',
    excerpt: 'Discover the hottest hair trends that will dominate this year...',
    content: 'Full article content here...',
    author: 'Sarah Johnson',
    authorId: 'u1',
    category: 'Trends',
    tags: ['hair', 'trends', '2024', 'style'],
    status: 'PUBLISHED',
    views: 15420,
    likes: 892,
  ...
  {
    id: 'a2',
    title: 'How to Choose the Perfect Barber',
    slug: 'how-to-choose-perfect-barber',
    excerpt: 'Tips and tricks for finding a barber that suits your style...',
    content: 'Full article content here...',
    author: 'Mike Williams',
    authorId: 'u2',
    category: 'Guides',
    tags: ['barber', 'tips', 'guide'],
    status: 'PENDING',
    views: 0,
    likes: 0,
    createdAt: new Date('2024-01-18'),
  ...
  {
    id: 'a3',
    title: 'The Rise of Mobile Grooming Services',
    slug: 'rise-mobile-grooming-services',
    excerpt: 'Mobile grooming is changing the industry landscape...',
    content: 'Full article content here...',
    author: 'Emma Davis',
    authorId: 'u3',
    category: 'Industry',
    tags: ['mobile', 'grooming', 'industry'],
    status: 'DRAFT',
    views: 0,
    likes: 0,
    createdAt: new Date('2024-01-17'),
  ...
  {
    id: 'a4',
    title: 'Nail Art: A Complete Beginner\'s Guide',
    slug: 'nail-art-beginners-guide',
    excerpt: 'Everything you need to know to get started with nail art...',
    content: 'Full article content here...',
    author: 'Lisa Chen',
    authorId: 'u4',
    category: 'Guides',
    tags: ['nails', 'art', 'beginner', 'guide'],
    status: 'REJECTED',
    views: 0,
    likes: 0,
    createdAt: new Date('2024-01-16'),
    updatedAt: new Date('2024-01-17'),
    adminNotes: 'Content needs more detail and original images.',
  },
];

// Sample Advertising Requests
const sampleAdRequests: AdRequest[] = [
  {
    id: 'ad1',
    businessName: 'Elite Cuts & Style',
    businessId: 'b1',
    ...
    clicks: 0,
    conversions: 0,
    notes: 'Would like to promote our new location opening.',
    createdAt: new Date('2024-01-18'),
  },
  {
    id: 'ad2',
    businessName: 'Glamour Studio',
    businessId: 'b2',
    contactEmail: 'glamour@example.com',
  ...
  },
  {
    ...
    businessId: 'b3',
    contactEmail: 'quickcuts@example.com',
...
const sampleReports: Report[] = [
  {
    ...
    description: 'This user has been sending unsolicited promotional messages to multiple users.',
    status: 'PENDING',
    createdAt: new Date('2024-01-18'),
  },
  {
    ...
    reportedUserId: 'b3',
    reportedUserName: 'Questionable Services',
    reportedUserEmail: 'contact@questionable.com',
    type: 'BUSINESS',
    reason: 'Fake reviews',
    description: 'This business appears to have fake reviews. All 5-star reviews are from accounts created on the same day.',
    status: 'INVESTIGATING',
    createdAt: new Date('2024-01-17'),
    adminNotes: 'Currently analyzing review patterns.',
  },
  {
    id: 'r3',
    reporterId: 'u3',
    ...
    reportedUserId: 'u6',
    reportedUserName: 'Harasser',
    reportedUserEmail: 'baduser@example.com',
    type: 'MESSAGE',
    reason: 'Harassment',
    ...
    createdAt: new Date('2024-01-15'),
    resolvedAt: new Date('2024-01-16'),
    adminNotes: 'User warned and suspended for 7 days.',
    action: 'SUSPENSION',
  },
];
...
const sampleBlockedUsers: BlockedUser[] = [
  {
    id: 'bu1',
    userId: 'u10',
    userName: 'Scam Artist',
    userEmail: 'scam@example.com',
    blockedBy: 'admin',
    blockedAt: new Date('2024-01-15'),
    reason: 'Fraudulent activity - attempting to scam customers',
    appealStatus: 'PENDING',
    appealReason: 'I was wrongly accused. Please review my case.',
    appealDate: new Date('2024-01-16'),
    adminNotes: 'Multiple reports from different customers confirmed fraudulent behavior.',
  },
  {
    id: 'bu2',
    userId: 'u11',
    userName: 'Harasser123',
    userEmail: 'harasser@example.com',
    blockedBy: 'admin',
    blockedAt: new Date('2024-01-10'),
    reason: 'Repeated harassment of users and providers',
    originalReportId: 'r3',
    appealStatus: 'REJECTED',
    appealReason: 'The messages were taken out of context.',
    appealDate: new Date('2024-01-12'),
    adminNotes: 'Evidence shows clear pattern of harassment. Appeal rejected.',
  },
  {
    id: 'bu3',
    userId: 'u12',
    userName: 'FakeReviews',
    userEmail: 'fake@example.com',
    blockedBy: 'admin',
    blockedAt: new Date('2024-01-08'),
    reason: 'Creating fake accounts to post reviews',
    appealStatus: 'NONE',
    unblockScheduledAt: new Date('2024-02-08'),
    adminNotes: 'Temporary block - 30 days. Will be auto-unblocked.',
  },
];

// Sample Support Messages
const sampleSupportMessages: SupportMessage[] = [
  {
    id: 'sm1',
    userId: 'u20',
    userName: 'Confused Customer',
    userEmail: 'confused@example.com',
    subject: 'Cannot complete my booking',
    message: 'I\'ve been trying to book an appointment but the payment keeps failing. I\'ve tried multiple cards.',
    category: 'TECHNICAL',
    priority: 'HIGH',
    status: 'OPEN',
    replies: [],
  ...
  },
  {
    ...
    message: 'I cancelled my booking 3 days ago but still haven\'t received my refund. This is unacceptable!',
    category: 'BILLING',
    priority: 'URGENT',
    status: 'IN_PROGRESS',
    replies: [
      { id: 'rep1', from: 'ADMIN', message: 'We apologize for the delay. We\'re looking into this now.', createdAt: new Date('2024-01-17'), adminName: 'Support Team' },
    ],
    createdAt: new Date('2024-01-16'),
    updatedAt: new Date('2024-01-17'),
  ...
  },
  {
    ...
    message: 'Just wanted to say I love your platform! Found an amazing barber near me.',
    category: 'FEEDBACK',
    priority: 'LOW',
    status: 'RESOLVED',
    replies: [
      { id: 'rep2', from: 'ADMIN', message: 'Thank you so much for the kind words! We\'re glad you had a great experience.', createdAt: new Date('2024-01-15'), adminName: 'Support Team' },
    ],
    createdAt: new Date('2024-01-15'),
    updatedAt: new Date('2024-01-15'),
  },
...
const sampleClaims: InsuranceClaim[] = [
  {
    ...
    customerId: 'u30',
    customerName: 'Injured Customer',
    customerEmail: 'injured@example.com',
    providerId: 'b10',
    providerName: 'Sharp Cuts',
    bookingId: 'booking123',
    type: 'INJURY',
    description: 'Received a cut on my ear during haircut that required medical attention.',
    amount: 250,
    currency: 'USD',
    status: 'UNDER_REVIEW',
    incidentDate: new Date('2024-01-15'),
    submittedAt: new Date('2024-01-16'),
    documents: ['medical_report.pdf', 'photo_evidence.jpg'],
  },
  {
    id: 'ic2',
    claimNumber: 'CLM-2024-002',
    customerId: 'u31',
    customerName: 'Allergic Reaction',
    customerEmail: 'allergic@example.com',
    providerId: 'b11',
    providerName: 'Beauty Haven',
    bookingId: 'booking124',
    type: 'ALLERGIC_REACTION',
    description: 'Had a severe allergic reaction to the hair dye used. Required emergency room visit.',
    amount: 500,
    currency: 'USD',
    status: 'APPROVED',
    ...
    reviewedBy: 'Admin',
    adminNotes: 'Confirmed allergic reaction from provided medical documentation.',
    resolution: 'Approved for full payout.',
  },
  {
    id: 'ic3',
    claimNumber: 'CLM-2024-003',
    customerId: 'u32',
    customerName: 'Property Damage',
    customerEmail: 'damage@example.com',
    providerId: 'b12',
    providerName: 'Mobile Grooming',
    bookingId: 'booking125',
    type: 'DAMAGE',
    description: 'Provider accidentally spilled hair dye on my expensive rug during mobile service.',
    amount: 350,
    currency: 'USD',
    status: 'REJECTED',
    ...
    reviewedBy: 'Admin',
    adminNotes: 'Insufficient evidence linking damage to service provider.',
    resolution: 'Claim rejected. Customer advised to pursue through provider directly.',
  },
];
...
const samplePageContent: PageContent[] = [
  {
    id: 'pc1',
    page: 'about',
    title: 'About GroomConnect',
    content: 'GroomConnect is the leading platform connecting customers with professional grooming services...',
  ...
  },
  {
    ...
    content: 'By using GroomConnect, you agree to the following terms and conditions...',
  ...
  },
  {
    ...
    content: 'Our safety guidelines ensure a secure experience for all users...',
...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({ initialTab = 'overview' }) => {
  ...
  const mockUsers = [
    ...
    { id: 'u2', name: 'Jane Smith', email: 'jane@example.com', role: 'CUSTOMER', roles: ['CUSTOMER'], status: 'ACTIVE', joinedAt: new Date('2024-01-10'), totalSpent: 520 },
    { id: 'u3', name: 'Mike Johnson', email: 'mike@example.com', role: 'BUSINESS_OWNER', roles: ['CUSTOMER', 'BUSINESS_OWNER'], status: 'ACTIVE', joinedAt: new Date('2024-01-08'), totalEarnings: 2400, totalSpent: 150 },
    { id: 'u4', name: 'Sarah Wilson', email: 'sarah@example.com', role: 'CUSTOMER', roles: ['CUSTOMER'], status: 'SUSPENDED', joinedAt: new Date('2024-01-05'), totalSpent: 85 },
    { id: 'u5', name: 'Elite Cuts', email: 'elite@example.com', role: 'BUSINESS_OWNER', roles: ['CUSTOMER', 'BUSINESS_OWNER'], status: 'ACTIVE', joinedAt: new Date('2024-01-01'), totalEarnings: 5200, totalSpent: 75 },
  ];
  ...
  const [premiumListings, setPremiumListings] = useState(samplePremiumListings);
  ...
  // Mock users data - now in state so we can modify it
  const [usersList, setUsersList] = useState(mockUsers);

  // API Data states
  const [apiUsers, setApiUsers] = useState<typeof mockUsers>([]);
  const [apiReports, setApiReports] = useState<Report[]>(sampleReports);
  const [apiBans, setApiBans] = useState<BlockedUser[]>(sampleBlockedUsers);
  const [apiTickets, setApiTickets] = useState<SupportMessage[]>(sampleSupportMessages);
  const [apiClaims, setApiClaims] = useState<InsuranceClaim[]>(sampleClaims);
  const [apiArticles, setApiArticles] = useState<Article[]>(sampleArticles);
  const [apiAds, setApiAds] = useState<AdRequest[]>(sampleAdRequests);
  const [apiListings, setApiListings] = useState<typeof samplePremiumListings>(samplePremiumListings);
  const [apiDisputes, setApiDisputes] = useState<Dispute[]>(sampleDisputes);
  const [apiPageContent, setApiPageContent] = useState<PageContent[]>(samplePageContent);
  ...
  const fetchOverview = useCallback(async () => {
    try {
      ...
      if (res.ok) {
        ...
        if (data.settings) {
          setSettings({
            platformFee: data.settings.platformFee || 15,
            minWithdrawal: data.settings.minWithdrawal || 50,
            maintenanceMode: data.settings.maintenanceMode || false,
            emailNotifications: data.settings.emailNotifications ?? true,
            smsNotifications: data.settings.smsNotifications || false,
            autoApprove: data.settings.autoApproveBusinesses || false,
            requireIdVerification: data.settings.requireIdVerification ?? true,
            featuredListingPrice: data.settings.featuredListingPrice || 99,
            premiumListingPrice: data.settings.premiumListingPrice || 49,
          });
        }
      }
    } catch (error) {
  ...
  useEffect(() => {
        ...
        switch (activeTab) {
          ...
          case 'reports':
            ...
            if (reportsRes.ok) {
              ...
              setApiReports(reportsData.reports || []);
            }
            break;
          case 'blocked':
          ...
          case 'support':
            ...
            if (ticketsRes.ok) {
              ...
              setApiTickets(ticketsData.tickets || []);
            }
            break;
          case 'claims':
            ...
            if (claimsRes.ok) {
              ...
              setApiClaims(claimsData.claims || []);
            }
            break;
          case 'articles':
            const articlesRes = await fetch('/api/articles?admin=true');
            if (articlesRes.ok) {
              const articlesData = await articlesRes.json();
              setApiArticles(articlesData.articles || []);
            }
            break;
          case 'advertising':
            ...
            if (adsRes.ok) {
              ...
              setApiAds(adsData.advertisements || []);
            }
            break;
          case 'listings':
          ...
          case 'disputes':
            ...
            if (disputesRes.ok) {
              ...
              setApiDisputes(disputesData.disputes || []);
            }
            break;
          case 'page-content':
            const pagesRes = await fetch('/api/admin/page-content');
            if (pagesRes.ok) {
              const pagesData = await pagesRes.json();
              setApiPageContent(pagesData.pages || []);
            }
            break;
        }
      } catch (error) {
    ...
    if (dataFetched && activeTab !== 'overview' && activeTab !== 'settings' && !['pending', 'approved', 'rejected'].includes(activeTab)) {
      fetchTabData();
    }
  ...
  const handleSaveListing = async () => {
    ...
    try {
      ...
      setPremiumListings(prev => prev.map(l =>
  ...
  // Filter by search
  const filterBySearch = (apps: typeof applications) => {
  ...
  const stats = {
    ...
    totalBusinesses: overviewData?.overview.totalBusinesses || businesses.length,
    pendingApprovals: overviewData?.pending.applications || pendingApps.length,
    totalRevenue: overviewData?.overview.totalRevenue || sampleRevenue.totalRevenue,
    activeBookings: overviewData?.monthly.bookings || 89,
    monthlyGrowth: overviewData?.overview.revenueGrowth || 12.5,
    totalTransactions: sampleRevenue.totalTransactions,
    avgRating: 4.7,
  ...
  const handleApprove = async (applicationId: string) => {
    ...
    try {
      ...
      approveApplication(applicationId, user?.id || 'admin');
  ...
  const handleReject = async () => {
    ...
    try {
      await new Promise(resolve => setTimeout(resolve, 1000));
      rejectApplication(selectedApplication, user?.id || 'admin', rejectReason);
          ...
          <FadeIn delay={0.3}>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-4 rounded-lg bg-muted/50">
                    <div>
                      ...
                      <p className="text-2xl font-bold">${sampleRevenue.totalRevenue.toLocaleString()}</p>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="p-3 rounded-lg bg-muted/30">
                      ...
                      <p className="text-lg font-bold">${sampleRevenue.commissions.toLocaleString()}</p>
                    </div>
                    <div className="p-3 rounded-lg bg-muted/30">
                      <p className="text-xs text-muted-foreground">Listing Revenue</p>
                      <p className="text-lg font-bold">${sampleRevenue.listingRevenue}</p>
                    </div>
                  </div>
                </div>
              </GlassCard>
              ...
              <GlassCard className="p-6">
                ...
                <div className="space-y-3">
                  {sampleDisputes.filter(d => d.status !== 'RESOLVED').slice(0, 3).map((dispute) => (
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">${sampleRevenue.thisMonth.revenue.toLocaleString()} this month</p>
                    </div>
                  </button>
                </div>
              </GlassCard>
              ...
              <GlassCard className="p-6">
                ...
                <div className="space-y-3">
                  {['Elite Cuts & Style', 'Glamour Studio', 'Serenity Spa'].map((name, i) => (
                    <div key={name} className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                      <span className="text-lg font-bold text-primary">#{i + 1}</span>
                      <div className="flex-1">
                        <p className="font-medium text-sm">{name}</p>
                        <p className="text-xs text-muted-foreground">{Math.floor(Math.random() * 50) + 50} bookings</p>
                      </div>
                      <span className="text-sm font-bold">${(Math.random() * 5000 + 2000).toFixed(0)}</span>
                    </div>
                  ))}
                </div>
              </GlassCard>
          ...
          <FadeIn delay={0.3}>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
              ...
              <GlassCard className="p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-muted-foreground">Commissions</p>
                    <p className="text-2xl font-bold">${sampleRevenue.commissions.toLocaleString()}</p>
                  </div>
                </div>
              </GlassCard>
              <GlassCard className="p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-muted-foreground">Listing Revenue</p>
                    <p className="text-2xl font-bold">${sampleRevenue.listingRevenue}</p>
                  </div>
                </div>
              </GlassCard>
              <GlassCard className="p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold">{sampleRevenue.totalTransactions}</p>
                  </div>
                </div>
              </GlassCard>
            </div>
            ...
            <GlassCard className="p-6 mb-6">
              ...
              <div className="flex items-end gap-4 h-48">
                {sampleRevenue.chartData.map((data, i) => (
              ...
              <GlassCard className="p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center p-3 rounded-lg bg-muted/50">
                    ...
                    <span className="font-bold">${sampleRevenue.thisMonth.commissions.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between items-center p-3 rounded-lg bg-muted/50">
                    <span>Last Month</span>
                    <span className="font-bold">${sampleRevenue.lastMonth.commissions.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between items-center p-3 rounded-lg bg-muted/50">
                        ...
                        <div className="flex-1">
                          <div className="flex items-start gap-3">
                            ...
                            <div className="min-w-0">
                              ...
                              <p className="text-sm text-muted-foreground">{app.businessDescription}</p>
                            </div>
                          </div>
                          ...
                          <div className="grid grid-cols-2 gap-3 mt-4 text-sm">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span>{app.businessCity}, {app.businessCountry}</span>
                            </div>
                          </div>

                          <div className="mt-4 p-3 rounded-lg bg-muted/50">
                            <p className="text-xs font-medium text-muted-foreground mb-1">ID VERIFICATION</p>
                            <div className="flex items-center gap-4">
                              <div>
                                <span className="text-xs text-muted-foreground">Type:</span>
                                <span className="ml-1 font-medium">{app.idType}</span>
                              </div>
                              <div>
                                <span className="text-xs text-muted-foreground">Number:</span>
                                <span className="ml-1 font-mono">{app.idNumber}</span>
                              </div>
                            </div>
                          </div>
                        </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleArticles.filter(a => a.status === 'PENDING').length}</p>
                ...
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleArticles.filter(a => a.status === 'PUBLISHED').length}</p>
                ...
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleArticles.filter(a => a.status === 'DRAFT').length}</p>
                ...
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleArticles.filter(a => a.status === 'REJECTED').length}</p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleClaims.filter(c => c.status === 'SUBMITTED').length}</p>
                ...
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleClaims.filter(c => c.status === 'UNDER_REVIEW').length}</p>
                ...
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleClaims.filter(c => c.status === 'APPROVED').length}</p>
                ...
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleClaims.filter(c => c.status === 'REJECTED').length}</p>
                      <p className="text-xs text-muted-foreground">Rejected</p>
                    </div>
                  </div>
                </GlassCard>
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">${sampleClaims.filter(c => c.status === 'APPROVED' || c.status === 'PAID').reduce((acc, c) => acc + c.amount, 0)}</p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleReports.filter(r => r.status === 'PENDING').length}</p>
                      <p className="text-xs text-muted-foreground">Pending</p>
                    </div>
                  </div>
                </GlassCard>
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleReports.filter(r => r.status === 'INVESTIGATING').length}</p>
                ...
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleReports.filter(r => r.status === 'RESOLVED').length}</p>
                ...
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleReports.filter(r => r.status === 'DISMISSED').length}</p>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="min-w-0">
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            <GlassBadge variant="outline">{report.type}</GlassBadge>
                            <GlassBadge
                              variant={
        ...
        {activeTab === 'blocked' && (
          <FadeIn delay={0.3}>
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleBlockedUsers.length}</p>
                ...
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleBlockedUsers.filter(b => b.appealStatus === 'PENDING').length}</p>
                ...
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleBlockedUsers.filter(b => b.unblockScheduledAt).length}</p>
              ...
              {/* Blocked Users List */}
              {sampleBlockedUsers.map((blocked) => (
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleAdRequests.filter(a => a.status === 'PENDING').length}</p>
                      <p className="text-xs text-muted-foreground">Pending</p>
                    </div>
                  </div>
                </GlassCard>
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleAdRequests.filter(a => a.status === 'ACTIVE').length}</p>
                ...
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleAdRequests.filter(a => a.status === 'COMPLETED').length}</p>
                ...
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">${sampleAdRequests.reduce((acc, a) => acc + a.budget, 0).toLocaleString()}</p>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="min-w-0">
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            <GlassBadge variant="outline">{ad.package}</GlassBadge>
                            <GlassBadge
                              variant={
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleSupportMessages.filter(s => s.status === 'OPEN').length}</p>
                ...
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleSupportMessages.filter(s => s.status === 'IN_PROGRESS').length}</p>
                ...
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleSupportMessages.filter(s => s.status === 'WAITING').length}</p>
                ...
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleSupportMessages.filter(s => s.status === 'RESOLVED').length}</p>
                      <p className="text-xs text-muted-foreground">Resolved</p>
                    </div>
                  </div>
                </GlassCard>
                <GlassCard className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{sampleSupportMessages.filter(s => s.priority === 'URGENT').length}</p>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="min-w-0">
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            <GlassBadge variant="outline">{msg.category}</GlassBadge>
                            <GlassBadge
                              variant={
          ...
          {showUserModal && selectedUser && (
            ...
            >
              ...
              >
                <GlassCard variant="elevated" className="p-6">
                  {(() => {
                    const u = usersList.find(user => user.id === selectedUser);
                    if (!u) return null;
                    return (
                      <>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="p-4 rounded-lg bg-muted/50">
                            ...
                            <p className="font-medium">{u.joinedAt.toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</p>
                          </div>
