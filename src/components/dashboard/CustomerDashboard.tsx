...
export const CustomerDashboard: React.FC<CustomerDashboardProps> = ({
  ...
  // Sample bookings with more detail
  const [bookings, setBookings] = useState<Booking[]>([
    {
      id: 'b1',
      businessId: '1',
      businessName: 'Elite Cuts & Style',
      businessImage: 'https://images.unsplash.com/photo-1585747860715-2ba37e788b70?w=100&h=100&fit=crop',
    ...
    },
    {
      ...
      businessImage: 'https://images.unsplash.com/photo-1560066984-138dadb4c035?w=100&h=100&fit=crop',
    ...
    },
    {
      ...
      businessImage: 'https://images.unsplash.com/photo-1604654894610-df63bc536371?w=100&h=100&fit=crop',
  ...
  const [reviews, setReviews] = useState<Review[]>([
    {
      ...
      businessName: 'Glamour Studio',
      rating: 5,
      comment: 'Amazing hair coloring service! Sarah really understood what I wanted and delivered beyond expectations.',
      date: '2024-01-16',
      service: 'Hair Coloring',
    },
    {
      ...
      businessName: 'Elite Cuts & Style',
      rating: 5,
      comment: 'Best haircut I\'ve ever had. Marcus is a true professional!',
      date: '2024-01-05',
      service: 'Classic Haircut',
    },
  ]);
            ...
            <GlassCard variant="default" className="p-6">
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                <div className="p-4 rounded-lg bg-muted/30">
                  ...
                  <p className="text-2xl font-bold">{formatPrice(185)}</p>
                </div>
                <div className="p-4 rounded-lg bg-muted/30">
