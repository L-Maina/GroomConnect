...
const sampleNotifications = [
  {
    ...
    message: 'Your appointment at Elite Cuts is confirmed for tomorrow at 2:00 PM',
    time: '5 min ago',
    isRead: false,
  },
  {
    ...
    title: 'New Review',
    message: 'Sarah M. left you a 5-star review! "Amazing service!"',
    time: '1 hour ago',
    isRead: false,
  },
  {
    ...
    message: 'You received $85.00 from John D.',
    time: '2 hours ago',
    isRead: true,
  },
  {
...
const sampleMessages = [
  {
    ...
    lastMessage: 'Sure, we have availability at 3 PM tomorrow.',
    time: '5 min ago',
    unread: true,
    avatar: 'E',
  },
  {
    id: '2',
    name: 'Glamour Studio',
    lastMessage: 'Your hair color appointment is confirmed!',
    time: '1 hour ago',
    unread: false,
    avatar: 'G',
  },
...
const clientNotifications = [
  {
    ...
    type: 'BOOKING_CONFIRMED' as const,
    title: 'Booking Confirmed',
    message: 'Your appointment at Elite Cuts is confirmed for tomorrow',
    time: '5 min ago',
    isRead: false,
  },
  {
...
const providerNotifications = [
  {
    ...
    type: 'BOOKING_CONFIRMED' as const,
    title: 'New Booking',
    message: 'John D. booked Classic Haircut for tomorrow at 10:00 AM',
    time: '5 min ago',
    isRead: false,
  },
  {
  ...
  },
  {
    ...
    type: 'PAYMENT_SUCCESS' as const,
    title: 'Payment Received',
    message: 'You received $85.00 from a booking',
    time: '3 hours ago',
    isRead: true,
  },
];
...
const adminNotifications = [
  {
    ...
    message: 'John Smith submitted a provider application',
    time: '10 min ago',
    isRead: false,
  },
  {
    ...
    message: 'New dispute #DSP-005 requires attention',
    time: '1 hour ago',
    isRead: false,
  },
  {
    ...
    message: 'Platform revenue exceeded $25,000 this month',
    time: '2 hours ago',
    isRead: true,
  },
];
...
export const Navbar: React.FC<NavbarProps> = ({ currentPage = 'home', onNavigate, isGuest }) => {
  ...
  const initialNotifications = isAdmin ? adminNotifications : currentMode === 'PROVIDER' ? providerNotifications : clientNotifications;
  const [notifications, setNotifications] = useState(initialNotifications);
  
  // Update notifications when mode changes
  React.useEffect(() => {
    setNotifications(isAdmin ? adminNotifications : currentMode === 'PROVIDER' ? providerNotifications : clientNotifications);
  }, [currentMode, isAdmin]);
  ...
  return (
    <>
      {/* Desktop Navigation - Full Width Liquid Glass */}
      <motion.nav
        initial={{ y: -100 }}
        animate={{ y: 0 }}
      ...
      >
        {/* Dark mode overlay */}
        <div className="absolute inset-0 dark:bg-slate-900/80 pointer-events-none" />
        <div className="relative w-full px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link 
                href="/" 
                className="flex items-center gap-1 brand-logo text-xl font-bold cursor-pointer"
                onClick={() => handleNavigate('home')}
              >
                      ...
                      {isNotificationsOpen && (
                        <>
                          ...
                          <motion.div
                            ...
                            className="absolute right-0 mt-2 w-80 sm:w-96 glass-modal rounded-xl shadow-xl z-50 overflow-hidden"
                          >
                      ...
                      {isProfileOpen && (
                        <>
                          ...
                          <motion.div
                            ...
                            animate={{ opacity: 1, y: 0, scale: 1 }}
                            exit={{ opacity: 0, y: 10, scale: 0.95 }}
                            className="absolute right-0 mt-2 w-72 glass-modal rounded-xl p-2 shadow-xl z-50"
                          >
      ...
      {/* Mobile Header - Clean Professional Liquid Glass Style */}
      <motion.header
        initial={{ y: -100 }}
        animate={{ y: 0 }}
        className="fixed top-0 left-0 right-0 z-40 md:hidden safe-area-top"
        style={{
      ...
      >
        {/* Dark mode overlay */}
        <div className="absolute inset-0 dark:bg-slate-900/85 pointer-events-none" />
        <div className="relative flex items-center justify-between h-14 px-3">
          {/* Left Side - Back Button for non-home pages */}
          ...
          <div className="flex-1 flex justify-center items-center">
            {currentPage === 'home' ? (
              <Link 
                href="/" 
                className="flex items-center gap-0.5 brand-logo text-lg font-bold cursor-pointer"
                onClick={() => handleNavigate('home')}
              >
                <span className="groom">Groom</span>
                <span className="connect">Connect</span>
          ...
          {isNotificationsOpen && (
            <>
              ...
              <motion.div
                ...
                animate={{ opacity: 1, y: 0, scale: 1 }}
                exit={{ opacity: 0, y: 10, scale: 0.95 }}
                className="glass-modal mx-3 mt-1 rounded-2xl shadow-2xl z-50 overflow-hidden"
              >
            ...
            >
              ...
              {isAuthenticated ? (
                ...
                <div className="px-6 py-8 text-center">
                  ...
                  <p className="font-semibold text-lg mb-2">Welcome to GroomConnect</p>
        ...
        {isSettingsOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto glass-modal rounded-2xl p-6"
