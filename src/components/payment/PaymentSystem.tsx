...
export const PaymentCheckout: React.FC<PaymentCheckoutProps> = ({
  ...
  const handlePayment = async () => {
    ...
    // Simulate success (90% chance) or failure (10% chance) for demo
  ...
  const handleShare = () => {
    ...
    if (navigator.share) {
      navigator.share({
        title: 'GroomConnect Booking Confirmation',
    ...
    <GlassModal isOpen={isOpen} onClose={onClose} title="Payment Receipt" size="md">
      <div className="space-y-6">
        ...
        <div className="text-center pb-4 border-b border-border">
          ...
          <h3 className="font-semibold text-lg">GroomConnect</h3>
    ...
    <GlassCard variant="default" className="p-5">
      ...
      <div className="space-y-4">
        ...
        <div className="text-sm text-muted-foreground space-y-1">
          <p>The platform fee helps us maintain and improve GroomConnect, including:</p>
