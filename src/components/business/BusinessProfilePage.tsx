  ...
  const sampleReviews: Review[] = [
    {
      ...
      bookingId: 'b1',
      rating: 5,
      comment: 'Amazing experience! The staff was professional and the haircut was exactly what I wanted. Will definitely be coming back.',
      isVerified: true,
    ...
    },
    {
      ...
      bookingId: 'b2',
      rating: 4,
      comment: 'Great service overall. The beard trim was perfect. Only minor wait time but worth it.',
      isVerified: true,
  ...
  return (
    ...
    >
      ...
      <div className="relative h-64 md:h-80 bg-gradient-to-br from-primary/20 to-secondary/20">
        ...
        <button
          onClick={onBack}
          className="hidden md:flex absolute top-4 left-4 z-10 glass p-2 rounded-lg hover:bg-white/20 transition-colors"
        >
        ...
        <div className="absolute top-4 right-4 z-10 flex gap-2">
          {canPerformClientActions && (
            ...
            >
              <Heart
                className={`h-5 w-5 ${isFavorite && !isGuest ? 'fill-red-500 text-red-500' : 'text-white'}`}
              />
            </button>
          )}
