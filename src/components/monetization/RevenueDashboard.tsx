...
export const RevenueDashboard: React.FC<RevenueDashboardProps> = ({
  ...
  const topBusinesses: TopPerformer[] = useMemo(() => [
    { id: '1', name: 'Elite Cuts & Style', type: 'BUSINESS', revenue: 12500, transactions: 234, growth: 15.2 },
    { id: '2', name: 'Glamour Beauty Spa', type: 'BUSINESS', revenue: 9800, transactions: 187, growth: 8.5 },
    { id: '3', name: 'Modern Barbershop', type: 'BUSINESS', revenue: 7650, transactions: 156, growth: -2.1 },
    { id: '4', name: 'Zen Wellness Center', type: 'BUSINESS', revenue: 6200, transactions: 98, growth: 22.4 },
    { id: '5', name: 'Style Studio', type: 'BUSINESS', revenue: 5400, transactions: 87, growth: 5.8 },
  ], []);
  
  const topCategories: TopPerformer[] = useMemo(() => [
    { id: '1', name: 'Haircuts & Styling', type: 'CATEGORY', revenue: 25000, transactions: 450, growth: 12.5 },
    { id: '2', name: 'Beard Grooming', type: 'CATEGORY', revenue: 15000, transactions: 320, growth: 8.2 },
    { id: '3', name: 'Spa & Wellness', type: 'CATEGORY', revenue: 12000, transactions: 180, growth: 15.8 },
    { id: '4', name: 'Nail Services', type: 'CATEGORY', revenue: 8500, transactions: 145, growth: 5.1 },
    { id: '5', name: 'Skin Care', type: 'CATEGORY', revenue: 6500, transactions: 98, growth: -3.2 },
  ], []);
  
  // Sample category breakdown
  const categoryBreakdown: RevenueByCategory[] = useMemo(() => [
    { category: 'Haircuts & Styling', transactionCount: 450, totalVolume: 125000, commissionRevenue: 18750, averageOrderValue: 278, growth: 12.5 },
    { category: 'Beard Grooming', transactionCount: 320, totalVolume: 48000, commissionRevenue: 7200, averageOrderValue: 150, growth: 8.2 },
    { category: 'Spa & Wellness', transactionCount: 180, totalVolume: 54000, commissionRevenue: 8100, averageOrderValue: 300, growth: 15.8 },
    { category: 'Nail Services', transactionCount: 145, totalVolume: 29000, commissionRevenue: 4350, averageOrderValue: 200, growth: 5.1 },
    { category: 'Skin Care', transactionCount: 98, totalVolume: 24500, commissionRevenue: 3675, averageOrderValue: 250, growth: -3.2 },
  ], []);
