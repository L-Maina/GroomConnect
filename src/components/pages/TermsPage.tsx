...
We reserve the right to suspend or terminate accounts that violate these terms or engage in suspicious activity.`,
  },
  {
    ...
    content: `Service providers on GroomConnect must:
...
Violations may result in removal from the platform and forfeiture of any pending payments.`,
  },
  {
    icon: CreditCard,
    title: 'Payments & Fees',
    content: `GroomConnect facilitates payments between customers and service providers. By using our payment system, you agree to:
...
We take violations seriously and may take legal action when appropriate.`,
  },
  {
    ...
    content: `GroomConnect is a marketplace platform connecting customers with independent service providers. We:
...
Users agree to indemnify and hold GroomConnect harmless from any claims arising from their use of the platform or services obtained through it.`,
  },
  {
    icon: Gavel,
...
GroomConnect reserves the right to make final determinations on disputes involving platform policy violations.`,
  },
  {
    icon: AlertTriangle,
    title: 'Termination',
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <FadeIn delay={0.1}>
          <GlassCard variant="bordered" className="mb-8">
            <p className="text-muted-foreground">
              Welcome to GroomConnect! These Terms of Service govern your use of our platform and 
              services. By accessing or using GroomConnect, you agree to be bound by these terms. 
        ...
        <FadeIn delay={0.5}>
          <GlassCard variant="gradient" className="mb-8">
            ...
            <div className="space-y-3 text-sm text-muted-foreground">
              <p>
                GroomConnect and its associated trademarks, logos, and content are the property of 
                GroomConnect Inc. and are protected by intellectual property laws.
              </p>
              <p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  GroomConnect after changes become effective constitutes acceptance of the revised terms.
                </p>
              </div>
            </div>
          </GlassCard>
        ...
        <FadeIn delay={0.8}>
          <GlassCard className="text-center">
            ...
            <div className="space-y-1 text-sm">
              <p><strong>Email:</strong> legal@groomconnect.com</p>
