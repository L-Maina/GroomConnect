...
const team = [
  ...
  },
  {
    ...
    bio: 'Built partnerships with 500+ beauty brands worldwide.',
...
const milestones = [
  { year: '2020', event: 'GroomConnect founded in Nairobi, Kenya' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <FadeIn className="text-center mb-16">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              About <GradientText>GroomConnect</GradientText>
            </h1>
          ...
          <GlassCard variant="elevated" glow className="mb-16">
            ...
            <div className="prose prose-slate max-w-none">
              <p className="text-muted-foreground mb-4">
                GroomConnect was born from a simple frustration: finding a great barber or stylist 
        ...
        <FadeIn delay={0.5}>
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground mt-2">The people behind GroomConnect</p>
          </div>
        ...
        <FadeIn delay={0.6}>
          <GlassCard variant="gradient" glow className="text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              ...
              seeking quality grooming services, GroomConnect is here for you.
            </p>
        ...
        <div className="mt-16 text-center">
          <GlassCard className="inline-block">
            ...
            <div className="flex flex-wrap justify-center gap-6 text-sm text-muted-foreground">
              ...
              <span className="hidden sm:inline">•</span>
              <a href="mailto:hello@groomconnect.com" className="flex items-center gap-2 hover:text-primary transition-colors">
                <span className="w-6 h-6 rounded-full gradient-bg flex items-center justify-center">
                  <Mail className="h-3 w-3 text-white" />
                </span>
                hello@groomconnect.com
              </a>
            </div>
          </GlassCard>
        </div>
