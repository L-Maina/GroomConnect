      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <FadeIn className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            We&apos;ve built multiple layers of protection to ensure every GroomConnect experience 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {safetyGuidelines.map((guideline, index) => (
                <motion.div
                  ...
                  className="flex gap-4 p-3 rounded-xl hover:bg-white/50 dark:hover:bg-slate-700/50 transition-colors"
                >
        ...
        <FadeIn delay={0.4}>
          <GlassCard variant="gradient" className="mb-12 overflow-hidden gradient-bg p-0">
            <div className="absolute inset-0 bg-gradient-to-br from-primary/40 via-primary/30 to-secondary/40 pointer-events-none" />
            <div className="relative p-6 md:p-8">
              <div className="text-center mb-8">
                ...
                >
                  ...
                  <span className="text-white text-sm font-medium">Protected by GroomConnect</span>
                </motion.div>
                <h2 className="text-3xl font-bold mb-2 text-white">Insurance & Protection</h2>
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6">
                <h3 className="text-xl font-semibold text-white mb-6 text-center">Choose Your Protection Plan</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {protectionPlans.map((plan, index) => (
                    ...
                    >
                      {plan.featured && (
                        <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 bg-gradient-to-r from-primary to-secondary rounded-full text-xs font-medium text-white">
                          Most Popular
                        </div>
                      )}
                      <h4 className="font-semibold text-white text-lg mb-1">{plan.name}</h4>
                      ...
                      <GlassButton 
                        ...
                        className={`w-full ${plan.featured ? '' : 'text-white border-white/30 hover:bg-white/10'}`}
          ...
          <GlassCard glow className="mb-12">
            <div className="flex flex-col md:flex-row items-start gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground mb-4">
                  At GroomConnect, your safety is not just a policy—it&apos;s our promise. We continuously 
                  ...
                  <form onSubmit={handleReportSubmit} className="space-y-4">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full p-3 rounded-xl border border-input bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm text-sm text-foreground dark:text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50"
                        required
                      >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full min-h-[120px] p-3 rounded-xl border border-input bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm text-sm text-foreground dark:text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 resize-none"
                        required
                      />
                    </div>
                    ...
                    {blockForm.reason === 'Other' && (
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full min-h-[80px] p-3 rounded-xl border border-input bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm text-sm text-foreground dark:text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 resize-none"
                          required
                        />
                      </div>
                    )}
                  ...
                  <div className="space-y-3">
                    {blockedUsers.map((block) => (
                      <motion.div
                        ...
                        animate={{ opacity: 1, x: 0 }}
                        className="flex items-center gap-3 p-3 rounded-xl border border-border/50 hover:bg-muted/30 transition-colors bg-white/30"
                      >
                        <img
