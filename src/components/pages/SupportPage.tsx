...
const faqs = [
  ...
  {
    category: 'provider',
    question: 'What fees does GroomConnect charge?',
    answer: 'GroomConnect charges a commission fee on completed bookings, which varies by subscription plan. Free tier providers pay 15%, Premium tier pays 10%, and Featured tier pays 8%. Detailed fee structures are available in your provider dashboard.',
    keywords: ['fees', 'commission', 'charges', 'pricing'],
  },
  {
    category: 'provider',
    question: 'How do I receive my earnings?',
    answer: 'Earnings are automatically transferred to your linked bank account on a weekly basis. You can also request instant payouts for a small fee. Minimum payout threshold is $25.',
...
export const SupportPage: React.FC<SupportPageProps> = ({ onBack, onNavigate }) => {
  ...
  const handleStartChat = () => {
    ...
    setChatMessages([
      { type: 'bot', message: 'Hello! 👋 Welcome to GroomConnect Support. How can I help you today?', timestamp: new Date() }
    ]);
  };
          ...
          <FadeIn delay={0.3}>
            <div className="space-y-4">
              ...
              <GlassCard hover className="group">
                <a href="tel:+15551234567" className="flex items-center gap-4">
              ...
              {/* Email */}
              <GlassCard hover className="group">
                <a href="mailto:support@groomconnect.com" className="flex items-center gap-4">
                  <div className="w-14 h-14 rounded-xl gradient-bg flex items-center justify-center shadow-glow-sm group-hover:shadow-glow transition-all">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-primary font-medium">support@groomconnect.com</p>
                  </div>
                  <ExternalLink className="h-4 w-4 text-muted-foreground group-hover:text-primary transition-colors" />
                </a>
              </GlassCard>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full min-h-[140px] p-4 rounded-xl border border-input bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm text-sm text-foreground dark:text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary resize-none transition-all"
                    required
                  />
                </div>
            ...
            >
              ...
              <div className="gradient-bg p-4 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-white">GroomConnect AI Support</h3>
              ...
              {/* Input */}
              <form onSubmit={handleSendChatMessage} className="p-4 border-t border-border/50 bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm">
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-3 rounded-xl border border-input bg-white/80 dark:bg-slate-700/80 backdrop-blur-sm text-sm text-foreground dark:text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all"
                  />
                  <motion.button
                    type="submit"
