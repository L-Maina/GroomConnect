...
const privacySections = [
  {
    ...
    content: [
      ...
      },
      {
        ...
        text: 'We collect information about the devices you use to access GroomConnect, including device type, operating system, unique device identifiers, and mobile network information.',
      },
    ],
  },
  {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <FadeIn delay={0.1}>
          <GlassCard variant="bordered" className="mb-8">
            <p className="text-muted-foreground">
              At GroomConnect, we take your privacy seriously. This Privacy Policy explains how we 
              collect, use, disclose, and safeguard your information when you use our platform. 
              Please read this policy carefully. By using GroomConnect, you consent to the practices 
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="space-y-1 text-sm">
                  <p><strong>Email:</strong> privacy@groomconnect.com</p>
