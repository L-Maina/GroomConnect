  ...
  try {
    ...
    if (page) {
      ...
      if (!pageContent) {
        ...
        return NextResponse.json({ pageContent: defaultContent });
      }
...
function getDefaultContent(page: string): string {
  const contents: Record<string, string> = {
    about: 'GroomConnect is the leading platform connecting customers with professional grooming services. Our mission is to make it easy for people to find and book appointments with skilled barbers, hairstylists, nail technicians, and other grooming professionals in their area.',
    ...
    terms: 'By using GroomConnect, you agree to the following terms and conditions. Please read them carefully before using our services.',
