...
export async function uploadImage(
  ...
  const uploadOptions: Record<string, unknown> = {
    folder: options?.folder || 'groomconnect',
    resource_type: 'image',
...
export const FOLDERS = {
  AVATARS: 'groomconnect/avatars',
  BUSINESS_LOGOS: 'groomconnect/business-logos',
  PORTFOLIO: 'groomconnect/portfolio',
  SERVICE_IMAGES: 'groomconnect/services',
  COVER_IMAGES: 'groomconnect/covers',
} as const;
